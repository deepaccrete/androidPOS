...
class _ComparisonByMonthState extends State<ComparisonByMonth> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Comparison By Month',style: GoogleFonts.poppins(color: Colors.white),),
        centerTitle: true,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Item Report',style: GoogleFonts.poppins(fontWeight:FontWeight.w600,fontSize: 18),),
              SizedBox(height: 10,),
              Text('Comparison of Current Month with Previous \n Month',style: GoogleFonts.poppins(fontWeight:FontWeight.w400,fontSize: 16),),
              ...
              DataTable(
                ...
                columns: [
                  ...
                  DataColumn(label: Container(
                    ...
                    width: width * 0.3,
                    // height: height * 0.05,
                    child: Text("Previous month",style: GoogleFonts.poppins(
                        fontWeight: FontWeight.bold, color: Colors.black)),
                  )),
                  ...
                  DataColumn(label: Container(
                    ...
                    width: width * 0.3,
                    // height: height * 0.05,
                    child:Text("Current month",style: GoogleFonts.poppins(
                        fontWeight: FontWeight.bold, color: Colors.black)),
                  )),
                ],
                ...
                rows: [
                  ...
                  DataRow(
                      ...
                      cells: [
                        ...
                        DataCell(Center(child: Text("559"))),
