...
class _ComparisonByYearState extends State<ComparisonByYear> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Comparison By Year',style: GoogleFonts.poppins(color: Colors.white),),
        centerTitle: true,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
              Text('Comparison of Current Year with Previous \n Year',style: GoogleFonts.poppins(fontWeight:FontWeight.w400,fontSize: 16),),
              ...
              DataTable(
                ...
                columns: [
                  ...
                  DataColumn(label: Container(
                    ...
                    width: width * 0.3,
                    // height: height * 0.05,
                    child: Text("Previous Year",style: GoogleFonts.poppins(
                        fontWeight: FontWeight.bold, color: Colors.black)),
                  )),
                  ...
                  DataColumn(label: Container(
                    ...
                    width: width * 0.3,
                    // height: height * 0.05,
                    child:Text("Current Year",style: GoogleFonts.poppins(
                        fontWeight: FontWeight.bold, color: Colors.black)),
                  )),
                ],
