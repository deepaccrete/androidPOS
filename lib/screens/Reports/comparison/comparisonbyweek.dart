...
class _ComparisonByWeekState extends State<ComparisonByWeek> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Comparison By Week',style: GoogleFonts.poppins(color: Colors.white),),
        centerTitle: true,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
              Text('Comparison of Current Week with Previous \n Week',style: GoogleFonts.poppins(fontWeight:FontWeight.w400,fontSize: 16),textAlign: TextAlign.start,),
