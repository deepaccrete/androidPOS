        ...
        child: Container(
          ...
          child:Column(
            ...
            children: [
              ...
              Text(" Total Discount Amount Today(Rs.) = 0 ",style: GoogleFonts.poppins(fontSize: 14,fontWeight: FontWeight.w600),),
              SizedBox(height:25),
              Text(" Total Discount Order Count = 0 ",style: GoogleFonts.poppins(fontSize: 14,fontWeight: FontWeight.w600),),
