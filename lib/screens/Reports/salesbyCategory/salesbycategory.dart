...
import 'package:flutter/material.dart';
import 'package:foodchow/constant/color.dart';
import 'package:foodchow/screens/Reports/salesbyCategory/daywiseitem.dart';
import 'package:foodchow/screens/Reports/salesbyCategory/monthwiseitems.dart';
import 'package:foodchow/screens/Reports/salesbyCategory/thisweek.dart';
import 'package:foodchow/screens/Reports/salesbyCategory/today.dart';
...
class _SalesbyCategoryState extends State<SalesbyCategory> {
  ...
  Widget _getBody() {
    switch (selectedFilter) {
      case "Today":
        return TodayByCategory();
      case "Day Wise":
        return DayWiseCategory();
      case "This Week":
        return ThisWeekCategory();
      case "Month Wise Sales":
        return MonthWiseCategory();
        case "Year Wise":
        return YearWiseCategory();
      default:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Sales By Category",style: GoogleFonts.poppins(color: Colors.white),),
        backgroundColor: primarycolor,
        centerTitle: true,
        leading: IconButton(
        ...
        child: Column(
          children: [
            ...
            Container(
                ...
                child: Text('Sales By Category Items',style: GoogleFonts.poppins(fontSize: 18,fontWeight: FontWeight.w600),)),
            SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Row(
