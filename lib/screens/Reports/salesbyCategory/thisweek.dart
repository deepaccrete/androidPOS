...
class ThisWeekCategory extends StatefulWidget {
  const ThisWeekCategory({super.key});

  @override
  State<ThisWeekCategory> createState() => _ThisWeekCategoryState();
}

class _ThisWeekCategoryState extends State<ThisWeekCategory> {
  @override
                ...
                columns: [
                  ...
                  DataColumn(
                      label: Container(
                        ...
                        width: width * 0.3,
                        // height: height * 0.05,
                        child: Text("Category Name",textAlign: TextAlign.center,style: GoogleFonts.poppins(
