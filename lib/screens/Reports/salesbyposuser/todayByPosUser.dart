...
class TodayByposUser extends StatefulWidget {
  const TodayByposUser({super.key});

  @override
  State<TodayByposUser> createState() => _TodayByposUserState();
}

class _TodayByposUserState extends State<TodayByposUser> {
        ...
        child: Container(
          ...
          child:Column(
            ...
            children: [
              ...
              Text(" Total Void Order Amount Today (Rs.) = 0 ",style: GoogleFonts.poppins(fontSize: 14,fontWeight: FontWeight.w600),),
              SizedBox(height:25),
              Text(" Total Void Order Count = 0 ",style: GoogleFonts.poppins(fontSize: 14,fontWeight: FontWeight.w600),),
